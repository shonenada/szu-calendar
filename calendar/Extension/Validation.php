    ...
    public function check()
    {
        ...
        foreach ($rules as $field => $set)
        {
            ...
            foreach ($set as $array)
            {
                ...
                elseif (method_exists('\Extension\Validators', $rule))
                {
                    // Use a method in this object
                    $method = new \ReflectionMethod('\Extension\Validators', $rule);
                ...
                if ( ! in_array($rule, $this->_empty_rules) AND ! Validators::not_empty($value))
                    continue;
